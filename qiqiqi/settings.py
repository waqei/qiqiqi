# Django settings for qiqiqi project.
...
DATABASES = {
    'default': {
        ...
        'NAME': 'qiche',                      # Or path to database file if using sqlite3.
...
MEDIA_ROOT = 'templates/static/image'
...
SECRET_KEY = 'p#@86axtg0uh^hg^k3w8fzm2qrsy1uuw53k!x^vl$fuu4bxz2c'
